            ...
            <main className="p-4">
                ...
                <section className="text-center py-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                        {[
                            { image: '2', title: 'โรคไข้หวัดใหญ่' },
                            { image: '3', title: 'รถล้ม การปฐมพยาบาล' },
                            { image: '4', title: 'อุบัติเหตุ ตกจากที่สูง' },
                            { image: '5', title: 'บาดเจ็บจากการเล่นกีฬา' },
                            { image: '6', title: 'บาดเจ็บจากของมีคม' },
                            { image: '7', title: 'ก้างปลาติดคอ' },
                        ].map((item, index) => (
                            <div key={index} className="bg-white p-6 rounded-lg shadow-md text-center font-anakotmai">
                                <img
                                    src={`/images/${item.image}.jpg`}
                                    onError={(e) => { e.target.onerror = null; e.target.src = `/images/${item.image}.png`; }}
                                    alt="Card Image"
                ...
                <div className="text-center py-8 font-anakotmai">
                    <button className="bg-yellow-600 text-white px-8 py-3 rounded-md transition duration-300 hover:bg-yellow-700">
                        สำรวจโรคต่างๆ
                    </button>
                </div>
